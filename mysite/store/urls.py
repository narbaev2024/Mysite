...
urlpatterns = [
    ...
    path('product/<int:pk>/', ProductViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}),
         name='product_detail'),
    path('photos/', ProductPhotoViewSet.as_view({'get': 'list', 'post': 'create'}), name='productphoto_list'),
    path('photos/<int:pk>/', ProductPhotoViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}),
